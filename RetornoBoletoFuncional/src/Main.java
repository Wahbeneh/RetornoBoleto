...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ProcessadorRetorno processador = new ProcessadorRetorno(new LeituraRetornoBancoBrasil()::lerArquivo);
        ...
        processador.setLeituraRetorno(new LeituraRetornoBradesco()::lerArquivo);
